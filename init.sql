...
INSERT INTO user (user_id, firstName, lastName, email_address, user_pw_hash, activated_account, activation_code, created_at, updated_at, `role`, class_id) VALUES(103, 'Chris', 'Lavelle', 'smelly@stinky.com', '$2b$10$RQ7UFNkKGPoQz4fvrRftfeAzuLTCK4xaYKNs8dbdL.FthadVQcaby', 1, 'MYCode1700079211887ncclovekk', '2023-11-15 20:13:31.902000', '2023-11-21 21:37:26.129577', 'user', 102);
INSERT INTO user (user_id, firstName, lastName, email_address, user_pw_hash, activated_account, activation_code, created_at, updated_at, `role`, class_id) VALUES(104, 'Emmitt', 'Kenny', 'emmykenner@gmail.com', '$2b$10$C0Q7B3XgW.a.X64ZJMFizeZ6dEQss62OplPUgM8Fnf0UiI8FOylhC', 1, 'MYCode1700079284914ncclovekk', '2023-11-15 20:14:44.920569', '2023-11-21 21:36:03.999773', 'user', 101);
INSERT INTO user (user_id, firstName, lastName, email_address, user_pw_hash, activated_account, activation_code, created_at, updated_at, `role`, class_id) VALUES(105, 'Michael', 'Jonathan', 'mickjohn@outlook.com', '$2b$10$e4lLTKkblVnL/XPUIRJk3O66z033qLBaZckto2Ogm3ACWav1tXPnK', 1, 'MYCode1700079326411ncclovekk', '2023-11-15 20:15:26.414418', '2023-11-21 21:36:04.005600', 'user', 101);
INSERT INTO user (user_id, firstName, lastName, email_address, user_pw_hash, activated_account, activation_code, created_at, updated_at, `role`, class_id) VALUES(106, 'Riccardo', 'DeGay', 'riccy_gay@yahoo.com', '$2b$10$S9vA5pXfgPa9cTpR4/xn4.tZO0XocDWVcSNX.zCR8FoG.Pq1qJGHq', 1, 'MYCode1700079386263ncclovekk', '2023-11-15 20:16:26.268000', '2023-11-15 20:16:26', 'user', NULL);
INSERT INTO user (user_id, firstName, lastName, email_address, user_pw_hash, activated_account, activation_code, created_at, updated_at, `role`, class_id) VALUES(107, 'Admin', 'Istrator', 'admin@admin.com', '$2b$10$rTGfdpd8miH6wMzMHGKuSOu2j1cTOJP8VzYjFs/HiiSq.2Gcpv7jS', 1, 'MYCode1700503654063ncclovekk', '2023-11-20 18:07:34.072000', '2023-11-20 18:07:34', 'admin', NULL);
...
-- Class init
INSERT INTO class (class_id, instructor_id) VALUES(102, 101);
INSERT INTO class (class_id, instructor_id) VALUES(101, 106);
